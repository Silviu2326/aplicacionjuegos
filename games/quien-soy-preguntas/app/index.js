...
export const QuienSoyPreguntasIndex = ({ navigation }) => {
  const resetGame = useQuienSoyPreguntasStore((state) => state.resetGame);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        ...
        {'\n\n'}
        El objetivo es simple: descubre la identidad del personaje, objeto o lugar mostrado en la pantalla haciendo preguntas de 'sí' o 'no'.
        {'\n\n'}
